...
for cu3 = 1:numel(cu_cx)
    ...
    Spread_Fact_cu(cu3,:) = sqrt(sum((dalpha)^2+(dgamma)^2)); %Spread_Fact_cu = res*2; %Spreading Factor %Uncertainty in Distance between a given Cube and Arc in centimeters
