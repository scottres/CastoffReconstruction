function [Psi_tot,Sn] = Castoff_Reconstruction_FUNC(face,v,aoi,Xs,Ys,Zs,alpha_p,alpha,alpha_pg,alpha_orig,gamma,minor,Ref,InOutTrajectory,InRoom,max_room_size,min_room_size,Lx,Ly,Lz,Nx,Ny,Nz,res,xmin,ymin,zmin,stdev,cu_cx,cu_cy,cu_cz,ip,isocubes,Spread_Fact_cu,Spread_Fact_upsilon,Spread_Fact_delrad,dalpha_range,dgamma_range,datamat,clstr_num,iq,comb_num,sig_n,fileID)
...
dgamma = sqrt(sum((d_gamma.^2)))*180/pi; %Root Sum Squared Gamma Impact Angle Uncertainty in Degrees
