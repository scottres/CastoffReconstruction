...
dalpha = (180/pi)*sqrt(sum((((sin(alpha_orig).^2)./(1-(sin(alpha_orig).^2))).*((1+(sin(alpha_orig).^2)).*(((stdev*0.1).^2)*ones(numstains,1))./((minor*0.1).^2))).^2)); %Alpha Impact Angle Uncertainty in Degrees
dgamma = (180/pi)*sqrt(sum(((0.4204*exp(0.0541*alpha_orig)).^2).^2)); %Gamma Impact Angle Uncertainty in Degrees
