...
SF_Theta_Floor = 5*pi/180; %Theta Spreading Factor Floor (degrees)
SF_Cu_Floor = res; %Theta Spreading Factor Floor (cm)
...
chi = linspace(0, 2*pi, 100); %Angle Vector for Plotting Known Cast-off Motion
