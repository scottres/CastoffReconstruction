...
elseif ~(any(isonorm(:) < (percentiles(2)^NUM_clstr)));
   ...
   Vol_1 = meshVolume(v1,[],f1) %Vol_Region_1 = (sum(isonorm(:) > percentiles(1)^NUM_clstr))*res^3
...
elseif ~(any(isonorm(:) < (percentiles(3)^NUM_clstr)));
   p5 = patch(isosurface(Xcu,Ycu,Zcu,isonorm,(percentiles(1)^NUM_clstr)),'FaceColor',cell2mat(colorcu(1)),'EdgeAlpha',transcu(1),'FaceAlpha',transcu(1));
   Vol_1 = meshVolume(v1,[],f1);abs(prod(room)) %Vol_Region_1 = (sum(isonorm(:) > percentiles(1)^NUM_clstr))*res^3
   ...
   Vol_2 = meshVolume(v2,[],f2) %Vol_Region_2 = (sum(isonorm(:) > percentiles(2)^NUM_clstr))*res^3
   ...
   Vol_1 = meshVolume(v1,[],f1) %Vol_Region_1 = (sum(isonorm(:) > percentiles(1)^NUM_clstr))*res^3
   p6 = patch(isosurface(Xcu,Ycu,Zcu,isonorm,(percentiles(2)^NUM_clstr)),'FaceColor',cell2mat(colorcu(2)),'EdgeAlpha',transcu(3),'FaceAlpha',transcu(2));
   Vol_2 = meshVolume(v2,[],f2) %Vol_Region_1 = (sum(isonorm(:) > percentiles(1)^NUM_clstr))*res^3
   ...
   Vol_3 = meshVolume(v3,[],f3) %Vol_Region_1 = (sum(isonorm(:) > percentiles(1)^NUM_clstr))*res^3
