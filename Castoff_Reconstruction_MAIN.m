...
elseif ~(any(isonorm(:) < (percentiles(2)^NUM_clstr)));
   ...
   volumes = [meshVolume(v1,[],f1)] %Vol_Region_1 = (sum(isonorm(:) > percentiles(1)^NUM_clstr))*res^3
...
elseif ~(any(isonorm(:) < (percentiles(3)^NUM_clstr)));
   ...
   volumes = [meshVolume(v1,[],f1) meshVolume(v2,[],f2)] %Vol_Region_1 = (sum(isonorm(:) > percentiles(1)^NUM_clstr))*res^3
   ...
   volumes = [meshVolume(v1,[],f1) meshVolume(v2,[],f2) meshVolume(v3,[],f3)] %Vol_Region_1 = (sum(isonorm(:) > percentiles(1)^NUM_clstr))*res^3
